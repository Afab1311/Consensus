...
const (
	ConsensusService_SendRequest_FullMethodName = "/grpc.ConsensusService/SendRequest"
)
...
type ConsensusServiceClient interface {
	SendRequest(ctx context.Context, in *NodeRequest, opts ...grpc.CallOption) (*NodeResponse, error)
}
...
func (c *consensusServiceClient) SendRequest(ctx context.Context, in *NodeRequest, opts ...grpc.CallOption) (*NodeResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(NodeResponse)
	err := c.cc.Invoke(ctx, ConsensusService_SendRequest_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ConsensusServiceServer interface {
	SendRequest(context.Context, *NodeRequest) (*NodeResponse, error)
...
func (UnimplementedConsensusServiceServer) SendRequest(context.Context, *NodeRequest) (*NodeResponse, error) {
...
func _ConsensusService_SendRequest_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(NodeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ConsensusServiceServer).SendRequest(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ConsensusService_SendRequest_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ConsensusServiceServer).SendRequest(ctx, req.(*NodeRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _ConsensusService_SendRequest_Handler,
		},
	},
